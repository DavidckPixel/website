...
/* package imageParser-0.1.0.0 */
#ifndef VERSION_imageParser
#define VERSION_imageParser "0.1.0.0"
#endif /* VERSION_imageParser */
#ifndef MIN_VERSION_imageParser
#define MIN_VERSION_imageParser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_imageParser */
...
#define CURRENT_COMPONENT_ID "imageParser-0.1.0.0-3kADkycEUV9FS8Bl7WQkJJ-imageParser"
